...
def create_csv_for_retinanet_multiple_predictions(input_dirs, out_file, label_arr, skip_box_thr=0.05,
                                                  intersection_thr=0.5, limit_boxes=300, type='avg'):
    out = open(out_file, 'w')
    ...
    for f in files:
        ...
        for i in range(len(merged_boxes)):
            ...
            if '/' not in google_name:
                ...
                if google_name in old_new_class_map.keys():
                    google_name = old_new_class_map[google_name]
...
if __name__ == '__main__':
    skip_box_thr = 0.06
    intersection_thr = 0.59
    limit_boxes = 2000
    type = 'avg'

    input_dirs = [
        OUTPUT_PATH + 'cache_retinanet_level_1_resnet101/',
        OUTPUT_PATH + 'cache_retinanet_level_1_resnet152/',
        OUTPUT_PATH + 'cache_retinanet_level_1_resnet50/',
    ]
