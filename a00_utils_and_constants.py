...
old_new_class_map = {
    'Bat': 'Bat (Animal)', 'Dairy': 'Dairy Product', 'Drill': 'Drill (Tool)',
    'Egg': 'Egg (Food)', 'Horn': 'French horn', 'Asparagus': 'Garden Asparagus',
    'Jaguar': 'Jaguar (Animal)', 'Lavender': 'Lavender (Plant)', 'Nail': 'Nail (Construction)',
    'Organ': 'Organ (Musical Instrument)', 'Pitcher': 'Pitcher (Container)', 'Ratchet': 'Ratchet (Device)',
    'Squash': 'Squash (Plant)', 'Sunflower': 'Common sunflower', 'Volleyball': 'Volleyball (Ball)',
...
def get_description_for_labels():
    out = open(INPUT_PATH + 'class-descriptions-boxable-old.csv')
    lines = out.readlines()
